                ...
                <div class="col-lg-12">
                    ...
                    <div class="button-bar">
                       <% if(rubro.getAplica_certificado()!=0) {%>
                        <a   class="btn btn-info" href="<%=PathCfg.CERTIFICADO %>?id_modulo=<%=OptionsCfg.MODULO_ACTIVO%>&id_objeto=<%= activo.getId()%>"><i class="fa fa-certificate fa-fw"></i> Certificados</a>
                        <%}%>
