...
-- Volcando estructura de base de datos para sanchez_salas
CREATE DATABASE IF NOT EXISTS `sanchez_salas` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `sanchez_salas`;


-- Volcando estructura para tabla sanchez_salas.sc_localidad
CREATE TABLE IF NOT EXISTS `sc_localidad` (
  `loc_id` int(11) NOT NULL AUTO_INCREMENT,
  `prov_id` int(11) NOT NULL,
  `loc_descripcion` varchar(255) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`loc_id`),
  KEY `FK_sc_localidad_sc_provincia` (`prov_id`),
  CONSTRAINT `FK_sc_localidad_sc_provincia` FOREIGN KEY (`prov_id`) REFERENCES `sc_provincia` (`prov_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2383 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla sanchez_salas.sc_localidad: ~2.371 rows (aproximadamente)
DELETE FROM `sc_localidad`;
/*!40000 ALTER TABLE `sc_localidad` DISABLE KEYS */;
INSERT INTO `sc_localidad` (`loc_id`, `prov_id`, `loc_descripcion`) VALUES
	(1, 1, '25 de Mayo'),
	(2, 1, '3 de febrero'),
	(3, 1, 'A. Alsina'),
...
/*!40000 ALTER TABLE `sc_localidad` ENABLE KEYS */;


-- Volcando estructura para tabla sanchez_salas.sc_provincia
CREATE TABLE IF NOT EXISTS `sc_provincia` (
  `prov_id` int(10) NOT NULL AUTO_INCREMENT,
  `prov_descripcion` varchar(255) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`prov_id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla sanchez_salas.sc_provincia: ~25 rows (aproximadamente)
DELETE FROM `sc_provincia`;
/*!40000 ALTER TABLE `sc_provincia` DISABLE KEYS */;
INSERT INTO `sc_provincia` (`prov_id`, `prov_descripcion`) VALUES
	(1, 'Buenos Aires'),
	(2, 'Buenos Aires-GBA'),
	(3, 'Capital Federal'),
	(4, 'Catamarca'),
	...
	(24, 'Tierra del Fuego'),
	(25, 'Tucumán');
/*!40000 ALTER TABLE `sc_provincia` ENABLE KEYS */;
