...
import utils.RemitoPdf;

/**
 *
 * @author Diego
 */
public class RemitoPrint extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try{
        if(request.getParameter("id")==null) throw new BaseException("Error de remito", "Debe seleccionar el remito");
            ...
            RemitoPdf remitoPdf = new RemitoPdf(remito);
            String fileName = String.format("Remito%d.pdf",remito.getNumero());
            String filePath = parametro.getValor() + File.separator + fileName;
            boolean generado = remitoPdf.createPdf(filePath);
            if (generado) {
