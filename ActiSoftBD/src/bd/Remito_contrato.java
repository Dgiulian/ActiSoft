...
public class Remito_contrato {
    ...
    Integer id_referencia                = 0;
    Integer remito_id_estado             = 0;
    Integer remito_facturado             = 0;
    Integer posicion                     = 0;
    Float   remito_detalle_cantidad      = 0f;
    String  activo_codigoNew             = "";
    ...
    public Remito_contrato setRemito_id_estado (Integer id_estado){
        this.remito_id_estado = id_estado;
        return this;
    }
    ...
    public Remito_contrato setContrato_detalle_posicion (Integer contrato_detalle_posicion){
        this.contrato_detalle_posicion = contrato_detalle_posicion;
        return this;
    }
    public Remito_contrato setRemito_detalle_cantidad (Float   remito_detalle_cantidad){
    ...
    public Remito_contrato setContrato_detalle_descripcion (String  contrato_detalle_descripcion){
        this.contrato_detalle_descripcion = contrato_detalle_descripcion;
        return this;
    }
    public Remito_contrato setContrato_detalle_id_subrubro (Integer contrato_detalle_id_subrubro){
        this.contrato_detalle_id_subrubro = contrato_detalle_id_subrubro;
        return this;
    }
    public Remito_contrato setContrato_detalle_id_divisa (Integer contrato_detalle_id_divisa){
        this.contrato_detalle_id_divisa = contrato_detalle_id_divisa;
        return this;
    }
    public Remito_contrato setContrato_detalle_precio (Float   contrato_detalle_precio){
        this.contrato_detalle_precio = contrato_detalle_precio;
        return this;
    }
    public Remito_contrato setContrato_detalle_porcentaje (Float   contrato_detalle_porcentaje){
