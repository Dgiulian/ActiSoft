 ...
 * @author Diego
 */
public class Kit_contrato_view extends Kit{
    ...
    public Kit_contrato_view(){}
    public Kit_contrato_view(Kit_contrato_view activo){
        super(activo);
    ...
    public Float getC_porcentaje(){
     ...
     public Kit_contrato_view setSr_codigo(String sr_codigo){
         this.sr_codigo  = sr_codigo;
         return this;
     }
     public Kit_contrato_view setSr_descripcion(String sr_descripcion){
         this.sr_descripcion  = sr_descripcion;
         return this;
     }
     public Kit_contrato_view setC_id_contrato(Integer c_id_contrato){
         this.c_id_contrato  = c_id_contrato;
         return this;
     }
     public Kit_contrato_view setC_posicion(Integer c_posicion){
         this.c_posicion  = c_posicion;
         return this;
     }
     public Kit_contrato_view setC_id_divisa(Integer c_id_divisa){
         this.c_id_divisa  = c_id_divisa;
         return this;
     }
     public Kit_contrato_view setC_precio(Float c_precio){
         this.c_precio  = c_precio;
         return this;
     }
     public Kit_contrato_view setC_porcentaje(Float c_porcentaje){
