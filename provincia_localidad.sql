...
CREATE TABLE IF NOT EXISTS `localidad` (
  ...
  CONSTRAINT `FK_sc_localidad_sc_provincia` FOREIGN KEY (`prov_id`) REFERENCES `provincia` (`prov_id`)
...
INSERT INTO `localidad` (`loc_id`, `prov_id`, `loc_descripcion`) VALUES
	(1, 1, '25 de Mayo'),
	(2, 1, '3 de febrero'),
	(3, 1, 'A. Alsina'),
...
-- Volcando estructura para tabla sanchez_salas.provincia
...
-- Volcando datos para la tabla sanchez_salas.provincia: ~25 rows (aproximadamente)
DELETE FROM `provincia`;
/*!40000 ALTER TABLE `provincia` DISABLE KEYS */;
INSERT INTO `provincia` (`prov_id`, `prov_descripcion`) VALUES
	(1, 'Buenos Aires'),
	(2, 'Buenos Aires-GBA'),
	(3, 'Capital Federal'),
	(4, 'Catamarca'),
